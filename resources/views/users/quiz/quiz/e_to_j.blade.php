        ...
        <form action="{{ route('quiz.quiz.result') }}" method="post">
            ...
            <div class="row">
                <div class="col-6 d-flex align-items-center">
                    <p class="text-second p-2 my-2 text-center w-50 m-auto fs-3 bg-yellow">apple</p>
                </div>
                <div class="col-6">
                    <div class="form-check ps-0">
                        <div class="">
                            <input type="radio" name="category" class="btn-check form-check-input" id="choice1" autocomplete="off">
                            <label class="btn btn-outline-yellow w-100 p-3 fs-5 border border-second rounded-4 my-2 fw-semibold" for="choice1">りんご</label>
                        </div>
                        <div class="div">
                            <input type="radio" name="category" class="btn-check form-check-input" id="choice2" autocomplete="off">
                            <label class="btn btn-outline-yellow w-100 p-3 fs-5 border border-second rounded-4 my-2 fw-semibold" for="choice2">ぶどう</label>
                        </div>
                        <div class="div">
                            <input type="radio" name="category" class="btn-check form-check-input" id="choice3" autocomplete="off">
                            <label class="btn btn-outline-yellow w-100 p-3 fs-5 border border-second rounded-4 my-2 fw-semibold" for="choice3">オレンジ</label>
                        </div>
                        <div class="div">
                            <input type="radio" name="category" class="btn-check form-check-input" id="choice4" autocomplete="off">
                            <label class="btn btn-outline-yellow w-100 p-3 fs-5 border border-second rounded-4 my-2 fw-semibold" for="choice4">バナナ</label>
                        </div>
                    </div>
                </div>
            </div>
