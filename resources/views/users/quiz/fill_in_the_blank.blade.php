...
<div class="container">
    ...
    <form action="{{ route('quiz.quiz.run', $num) }}" method="post">
        ...
        <div class="">
            ...
            <p class="text-second p-2 my-5 w-75 m-auto fs-3">{{ $quiz['example']['before'] }} <input type="text" name="input" class="form-control w-25 m-auto d-inline"> {{ $quiz['example']['after'] }}</p>
        </div>
